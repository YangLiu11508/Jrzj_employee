package jrjz_project_emplyoee.jrjz.htlc.com.jrzj_employee.view;
...
import jrjz_project_emplyoee.jrjz.htlc.com.jrzj_employee.util.DisplayUtils;

/**
 * Created by mjc on 2016/2/15.
 */
public class LoadingView extends View {
    ...
    //箭头的粗细程度
    private int mArcWidth = DisplayUtils.dip2px(getContext(),2);
...
//        drawArc(canvas, mRate);
    ...
    private void drawPointer(Canvas canvas) {
        ...
        canvas.drawArc(new RectF(getPaddingLeft(), getPaddingTop(), getPaddingLeft() + 2 * mRadius, getPaddingTop() + 2 * mRadius), -90, (float) (360 * mRate), false, mPaint);

//        canvas.rotate(mRotateArge + 60, getPaddingLeft() + mRadius, getPaddingTop() + mRadius);
//        Bitmap backgroundmap= BitmapFactory.decodeResource(getResources(), R.drawable.cycler);
//        canvas.drawBitmap(backgroundmap, new Matrix(), null);
